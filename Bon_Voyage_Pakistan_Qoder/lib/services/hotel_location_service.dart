...
class HotelLocationService {
  ...
  static const Map<String, GeoPoint> knownDestinations = {
    ...
    'rawalpindi': GeoPoint(latitude: 33.5651, longitude: 73.0169, label: 'Rawalpindi'),
    ...
    'murree': GeoPoint(latitude: 33.9070, longitude: 73.3943, label: 'Murree'),
    'murree & galiyat': GeoPoint(latitude: 33.9070, longitude: 73.3943, label: 'Murree & Galiyat'),
    ...
    'swat': GeoPoint(latitude: 35.2227, longitude: 72.4258, label: 'Swat / Kalam'),
    'swat / kalam': GeoPoint(latitude: 35.2227, longitude: 72.4258, label: 'Swat / Kalam'),
    'swat & kalam': GeoPoint(latitude: 35.2227, longitude: 72.4258, label: 'Swat & Kalam'),
    'kalam': GeoPoint(latitude: 35.4900, longitude: 72.5800, label: 'Kalam'),
    'naran': GeoPoint(latitude: 34.9089, longitude: 73.6517, label: 'Naran / Kaghan'),
    'naran / kaghan': GeoPoint(latitude: 34.9089, longitude: 73.6517, label: 'Naran / Kaghan'),
    'naran & kaghan': GeoPoint(latitude: 34.9089, longitude: 73.6517, label: 'Naran & Kaghan'),
    'kaghan': GeoPoint(latitude: 34.7800, longitude: 73.5300, label: 'Kaghan'),
